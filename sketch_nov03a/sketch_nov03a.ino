...
String BOTtoken = "000000000000000000000000000000";
...
void setup(){
  ...
  s->set_framesize(s, FRAMESIZE_XGA);  // FRAMESIZE_CIF
  ...
  err = gpio_isr_handler_add(GPIO_NUM_19, &detectsMovement, (void *) 19);  
  if (err != ESP_OK){
...
void handleNewMessages(int numNewMessages){
  ...
  for (int i = 0; i < numNewMessages; i++){
    ...
    if (text == "/help") {
      String welcome = "Don't worry. You can do:\n";
      welcome += "/photo : to takes a new photo\n";
      welcome += "Other wise you'll receive a photo whenever motion is detected.\n";
